        ...
        <motion.div
            ...
            <div className="p-4">
                ...
                <div className="mt-4 flex justify-between">
                    <Link to={`/blog-details/${id}`} className="bg-purple-500 text-white hover:bg-purple-600 transition px-4 py-2 rounded"  >
                        Details
                    </Link>
                    <button className=' px-4 py-2 text-white border  rounded  font-semibold bg-[#00e29a] hover:bg-[#2afcb9] transition' onClick={() => handleDeleteWishlist(_id)} > Remove to Wishlist
